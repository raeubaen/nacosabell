...
sig_file = ROOT.TFile("smeared_sig_5mgen_with_score_try2.root")
sig_tree = sig_file.Get("tree")
sig_hist = ROOT.TH1F("sig", "sig", 40, 0, 0.4)
sig_tree.Draw("mass>>sig", "55*500/5e6 * weight * (score > 0.27)")
...
bkg_tree.Draw("mass>>bkg", "500e3 * weight * (score > 0.27)")
