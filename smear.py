...
df = pd.read_csv("/afs/cern.ch/user/r/rgargiul/belleii/calo_reso_gnn_arxiv2306.04179_tab2.csv")
...
tree_eff =  tree_var(tree, "eff", (1,),  np.float32, "F")
